        ...
        <div className="mt-8 lg:mt-0 lg:ml-8">
          <form onSubmit={subscribeMember} className="sm:flex">
            ...
            <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <button
                type="submit"
                className="w-full flex items-center justify-center py-2 px-3 border border-transparent text-base font-medium font-sans rounded-md text-white bg-green-600 shadow-lg shadow-green-600/50 focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-green-600"
              >
                Subscribe
              </button>
            </div>
