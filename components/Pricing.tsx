      ...
      <div className="bg-white">
        <div className="container max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 font-sans">
          <div className="sm:flex sm:flex-col sm:align-center">
            <h1 className="text-5xl font-extrabold text-green-600 sm:text-center">Pricing Plans</h1>
          ...
          <div className="mt-12 space-y-4 sm:mt-16 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-6 lg:max-w-4xl lg:mx-auto xl:max-w-none xl:mx-0 xl:grid-cols-3">
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                <h2 className="text-xl leading-6 font-large text-gray-900">Individual</h2>
                ...
                <a href="#" className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">Sign up for Invidual</a>
              </div>
              <div className="pt-6 pb-8 px-6">
                ...
                <ul className="mt-6 space-y-4">
                  <li className="flex space-x-3 text-sm text-gray-500">
                    ...
                    <span className="text-sm text-gray-500">25k views/month</span>
                  </li>
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                <h2 className="text-xl leading-6 font-medium text-gray-900">Team</h2>
                <p className="mt-4 text-sm text-gray-500">All the basics for starting a new business</p>
                <p className="mt-8">
                  <span className="text-4xl font-extrabold text-gray-900">$24</span>
                  <span className="text-base font-medium text-gray-500">/mo</span>
                </p>
                <a href="#" className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">Sign up for Team</a>
              </div>
              <div className="pt-6 pb-8 px-6">
                <h3 className="text-xs font-medium text-gray-900 tracking-wide uppercase">What's included</h3>
                <ul className="mt-6 space-y-4">
                  <li className="flex space-x-3">
                    <FontAwesomeIcon icon={faCheck} />
                    <span className="text-sm text-gray-500">100k views/month</span>
                  </li>
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                <h2 className="text-xl leading-6 font-medium text-gray-900">Organization</h2>
                <p className="mt-4 text-sm text-gray-500">All the basics for starting a new business</p>
                <p className="mt-8">
                  <span className="text-4xl font-extrabold text-gray-900">$32</span>
                  <span className="text-base font-medium text-gray-500">/mo</span>
                </p>
                <a href="#" className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">Sign up for Organization</a>
              </div>
              <div className="pt-6 pb-8 px-6">
                <h3 className="text-xs font-medium text-gray-900 tracking-wide uppercase">What's included</h3>
                <ul className="mt-6 space-y-4">
                  <li className="flex space-x-3">
                    <FontAwesomeIcon icon={faCheck} />
                    <span className="text-sm text-gray-500">500k views/month</span>
                  </li>

                  <li className="flex space-x-3">
                    <FontAwesomeIcon icon={faCheck} />
                    <span className="text-sm text-gray-500">10 staff users</span>
                  </li>
